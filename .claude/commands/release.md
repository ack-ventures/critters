...
6. Review commits since last tag and check that README.md is up to date with any new features, config fields, CLI changes, or behavioral changes introduced since the previous release. If anything is missing, add the relevant documentation now.
